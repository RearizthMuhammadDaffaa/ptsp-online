...
const HasilPanjar = () => {
 ...
 const hargaPendaftaran = {
  ...
  const generateDocument = (title)=> {
    if(title == 'suami'){
        loadFile('file_doc/suami.docx', function(error,content){
          if(error){
            throw error;
          }
      ...
      loadFile('file_doc/istri.docx', function(error,content){
        if(error){
          throw error;
        }
        const zip = new PizZip(content);
      ...
      loadFile('file_doc/permohonan.docx', function(error,content){
        if(error){
          throw error;
        }
        const zip = new PizZip(content);
